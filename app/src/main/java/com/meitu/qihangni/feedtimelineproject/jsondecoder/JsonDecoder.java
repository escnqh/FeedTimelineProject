                    ...
                    if (methodName.startsWith("set")) {
                        ...
                        try {
                            ...
                            if (type == boolean.class || type == Boolean.class) {
                                method.invoke(t, jsonObject.getBoolean(attributeName));
                            } else if (type == byte.class || type == Byte.class) {
                                method.invoke(t, jsonObject.getInt(attributeName));
                                ...
                                method.invoke(t, jsonObject.getLong(attributeName));
                            } else if (type == float.class || type == Float.class) {
                                method.invoke(t, jsonObject.getDouble(attributeName));
                            } else if (type == double.class || type == Double.class) {
                                method.invoke(t, jsonObject.getDouble(attributeName));
                            } else if (type == String.class) {
                                method.invoke(t, jsonObject.getString(attributeName));
                                ...
                                // 获取List的泛型类型
                                Class<?> listType = (Class<?>) ((ParameterizedType) cls.getDeclaredField(attributeName).getGenericType()).getActualTypeArguments()[0];
                                // 为List属性进行赋值
