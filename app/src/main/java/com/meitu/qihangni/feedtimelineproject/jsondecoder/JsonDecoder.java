                ...
                if (methodName.startsWith("set")) {
                    ...
                    try {
                        ...
                        if (type == boolean.class || type == Boolean.class) {
                            method.invoke(t, jsonObject.optBoolean(attributeName));
                        } else if (type == byte.class || type == Byte.class) {
                            method.invoke(t, jsonObject.optString(attributeName));
                        } else if (type == char.class || type == Character.class) {
                            method.invoke(t, jsonObject.optString(attributeName));
                        } else if (type == short.class || type == Short.class) {
                            method.invoke(t, jsonObject.optInt(attributeName));
                        } else if (type == int.class || type == Integer.class) {
                            method.invoke(t, jsonObject.optInt(attributeName));
                        } else if (type == long.class || type == Long.class) {
                            method.invoke(t, jsonObject.optLong(attributeName));
                        } else if (type == float.class || type == Float.class) {
                            method.invoke(t, jsonObject.optDouble(attributeName));
